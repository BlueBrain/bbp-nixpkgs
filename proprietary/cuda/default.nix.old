...
let
  ...
  common =
    ...
    stdenv.mkDerivation rec {
      name = "cudatoolkit-backport-${version}";
      ...
      rpath = "${utils.makeLibraryPath runtimeDependencies}:${stdenv.cc.cc}/lib64";
      ...
      '' + stdenv.lib.optionalString (stdenv.lib.versionOlder version "8.0") ''
