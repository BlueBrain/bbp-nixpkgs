...
let
    ...
    default_mpi_rdma = mvapich2-rdma;
        ...
        synapsetool = pkgs.envModuleGen rec {
            name = "synapsetool";
            moduleFilePrefix = "nix/hpc";
            isLibrary = true;
        ...
        pytouchreader = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.pythonPackages; (
                getPyModRec [ pkgs.pytouchreader ]
            );
            conflicts = conflicts-modules ++ [ pytouchreader-py3 ];
            dependencies = [ python27-full ];
        };

        pytouchreader-py3 = pkgs.envModuleGen rec {
            name = "pytouchreader-py3";
            moduleFilePrefix = "nix/hpc";
            description = "pytouchreader module generated by nix";
            packages = with pkgs.python3Packages; (
                getPyModRec [ pkgs.pytouchreader-py3 ]
            );
            conflicts = conflicts-modules ++ [ pytouchreader ];
        ...
        spykfunc = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.python3Packages; ([
                pkgs.spykfunc
                pkgs.parquet-converters
            ] ++ getPyModRec [ pkgs.spykfunc ] ++ [ add-site-dir ]);
            conflicts = conflicts-modules;
            ...
            extraContent = ''
                setenv HADOOP_HOME "${pkgs.hadoop-bbp}"
                setenv JAVA_HOME "${pkgs.jre}"
                setenv SPARK_HOME "${pkgs.spark-bbp}"

                setenv PYSPARK_DRIVER_PYTHON " "
                setenv PYSPARK_PYTHON "${pkgs.python3Packages.python}/bin/${pkgs.python3Packages.python.executable}"
            '';
        ...
        pybb5 = pkgs.envModuleGen rec {
            name = "bb5";
            moduleFilePrefix = "nix/py36";
            description = "pybb5 module generated by nix";
            packages = with pkgs.python36Packages; ( getPyModRec [ bb5 ] );
        };

        basalt = with pkgs; envModuleGen rec {
            name = "basalt";
            moduleFilePrefix = "nix/py36";
            description = "C++11 Graph Storage library module generated by nix";
            packages = pkgs.python36Packages.getPyModRec [pkgs.python36Packages.basalt];
        };
        ...
        neurom = pkgs.envModuleGen rec {
            ...
            packages = pkgs.pythonPackages.getPyModRec [ pkgs.neurom ];
            conflicts = conflicts-modules;
        ...
        neurom-py3 = pkgs.envModuleGen rec {
            ...
            moduleFilePrefix = "nix/nse";
            description = "neuroM module generated by nix";
            packages = pkgs.python3Packages.getPyModRec [ pkgs.neurom-py3 ];
            conflicts = conflicts-modules;
        ...
        bluepy_0_6_1 = pkgs.envModuleGen rec {
            ...
            conflicts = conflicts-modules ++ [ bluepy bluepy_0_9_6 python36-full python36-light ];
        };
        ...
        bluepy_0_9_6 = pkgs.envModuleGen rec {
            ...
            conflicts = conflicts-modules ++ [ bluepy bluepy_0_6_1 python36-full python36-light ];
        };
        ...
        bbp-morphology-workflow = pkgs.envModuleGen rec {
            name = "bbp-morphology-workflow";
            moduleFilePrefix = "nix/nse";
            ignoreCollisions = true;
            description = "bbp-morphology-workflow module generated by nix";
            packages = with pkgs.pythonPackages; ( getPyModRec [ pkgs.bbp-morphology-workflow ] );
            conflicts = conflicts-modules;
        };
        ...
        gmsh-3 = pkgs.envModuleGen rec {
            name = "gmsh";
            version = "3.0.5";
            moduleFilePrefix = "nix";
            description = "gmsh module generated by nix";
            packages = [ pkgs.gmsh-3 ];
            conflicts = conflicts-modules;
            isDefault = true;
        };
       ...
       blender_2_8 = pkgs.envModuleGen rec {
            name = "blender";
            moduleFilePrefix = "nix";
        ...
        openscenegraph = pkgs.envModuleGen rec {
            name = "openscenegraph";
            moduleFilePrefix = "nix";
            setRoot = "OSG";
            isLibrary = true;
            description = "OpenSceneGraph module module generated by nix";
            packages = [
                pkgs.openscenegraph
            ];
            conflicts = conflicts-modules;
        ...
        regiodesics = pkgs.envModuleGen rec {
            name = "regiodesics";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "regiodesics module generated by nix";
            packages = [
                            pkgs.regiodesics
                       ];
            conflicts = conflicts-modules;
        };
        neuromorphovis = pkgs.envModuleGen rec {
            name = "neuromorphovis";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "neuromorphovis module generated by nix";
            packages = [
                            pkgs.neuromorphovis
                       ];
            extraContent = ''
        ...
        rtneuron2 = pkgs.envModuleGen rec {
            name = "rtneuron";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "rtneuron module generated by nix, old version";
            packages = [
                            pkgs.rtneuron2 pkgs.equalizer
                       ];
            extraContent = "prepend-path LD_LIBRARY_PATH $targetEnv/lib/";
            dependencies = [ brion virtualgl pyqt5 pyopengl ];
            conflicts = conflicts-modules;
        ...
        dcmtk = pkgs.envModuleGen rec {
            name = "dcmtk";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "dcmtk module generated by nix";
            packages = [
                            pkgs.dcmtk
                       ];
            conflicts = conflicts-modules;
        ...
        emsim = pkgs.envModuleGen rec {
            name = "emsim";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "emsim module generated by nix";
            packages = [
                            pkgs.emsim
                       ];
            conflicts = conflicts-modules;
        ...
        ultraliser = pkgs.envModuleGen rec {
            name = "ultraliser";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "ultraliser module generated by nix";
            packages = [
                            pkgs.ultraliser
                       ];
            conflicts = conflicts-modules;
        ...
        topology-viewer = pkgs.envModuleGen rec {
            name = "topology-viewer";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "topology-viewer module generated by nix";
            packages = [
                            pkgs.topology-viewer
                       ];
            conflicts = conflicts-modules;
            dependencies = [ brayns ];
            # for brayns plugins loaded by brayns inside LD_LIBRARY_PATH
            extraContent = "prepend-path LD_LIBRARY_PATH $targetEnv/lib/";

        };

        dti = pkgs.envModuleGen rec {
            name = "dti";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "dti module generated by nix";
            packages = [
                            pkgs.dti
                       ];
            conflicts = conflicts-modules;
        ...
        circuit-explorer = pkgs.envModuleGen rec {
            name = "circuit-explorer";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "circuit-explorer module generated by nix";
            packages = [
                            pkgs.circuit-explorer
                       ];
            conflicts = conflicts-modules;
            dependencies = [ brayns ];
            # for brayns plugins loaded by brayns inside LD_LIBRARY_PATH
        ...
        membraneless-organelles = pkgs.envModuleGen rec {
            name = "membraneless-organelles";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "membraneless-organelles module generated by nix";
            packages = [
        ...
        meshball = pkgs.envModuleGen rec {
            name = "meshball";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "meshball module generated by nix";
            packages = [
                            pkgs.meshball
                       ];
            conflicts = conflicts-modules;
        ...
        brain-atlas = pkgs.envModuleGen rec {
            ...
            isLibrary = true;
            description = "brain-atlas module generated by nix";
            packages = [
                            pkgs.brain-atlas
                       ];
            conflicts = conflicts-modules;
        ...
        diffusion-tensor-imaging = pkgs.envModuleGen rec {
            name = "diffusion-tensor-imaging";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "diffusion-tensor-imaging module generated by nix";
            packages = [
        ...
        morphology-synthesis = pkgs.envModuleGen rec {
            name = "morphology-synthesis";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "morphology-synthesis module generated by nix";
            packages = [
        ...
        molecular-systems = pkgs.envModuleGen rec {
            name = "molecular-systems";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "molecular-systems module generated by nix";
            packages = [
        ...
        python27-light = with pkgs; envModuleGen rec {
            ...
            dependencies = [ nss-wrapper manylinux1-python gcc ];
        };
        ...
        ipython = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.pythonPackages;
                      ...
                      ;
            conflicts = conflicts-modules ++ [ "ipython" ipython-py3 python36-full python36-light ];
        };
        ...
        ipython-py3 = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.python3Packages;
                      ...
                      ;
            conflicts = conflicts-modules ++ [ "ipython" ipython python27-full python27-light ];
        };
        ...
        python-opencv = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.pythonPackages;
                      ...
                      ;
            conflicts = conflicts-modules ++ [ python3-opencv python36-full python36-light ];
        };
        ...
        python3-opencv = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.python3Packages;
                      ...
                      ;
            conflicts = conflicts-modules ++ [ python-opencv python27-full python27-light ];
        };
        ...
        ipykernel = pkgs.envModuleGen rec {
            ...
            ignoreCollisions = true;
            conflicts = conflicts-modules ++ [ python36-light python36-full ];
        };
        ...
        pyopengl = pkgs.envModuleGen rec {
            name = "pyopengl";
            moduleFilePrefix = "nix/py27";
            isLibrary = true;
        ...
        elasticsearch-py3 = pkgs.envModuleGen rec {
            name = "elasticsearch";
            version = "1.9.0";
            moduleFilePrefix = "nix/py36";
            isLibrary = true;
            description = "elasticsearch module generated by nix";
            ignoreCollisions = true;
            packages = with pkgs.python3Packages;  ( getPyModRec [ pkgs.python3Packages.elasticsearch ] );
            conflicts = conflicts-modules;
        };
       ...
       phdf5 = pkgs.envModuleGen rec {
        ...
        petsc-32 = pkgs.envModuleGen rec {
            name = "petsc-32";
            isLibrary = true;
            description = "PETSc module generated by nix 32 bits compat";
            packages = [
                            pkgs.petsc-32
                       ];
            conflicts = conflicts-modules;
       ...
       cuda9 = if (pkgs.nvidia-x11-default != null) then (pkgs.envModuleGen rec {
        ...
        yo  = pkgs.envModuleGen rec {
            name = "yo";
            isLibrary = true;
            description = "yo module generated by nix";
            packages = [
                            pkgs.yo
                       ];
        };
        ...
        scikit-learn-py3 = pkgs.envModuleGen rec {
                name = "scikit-learn";
                moduleFilePrefix = "nix/py36";
                setRoot = "SCIKIT_LEARN";
                description = "scikit-learn module generated by nix";
                packages = with pkgs.python3Packages; ( getPyModRec [ pkgs.python3Packages.scikit-learn ] );
        };
        ...
        metis = pkgs.envModuleGen rec {
                name = "metis";
                moduleFilePrefix = "nix/py27";
                description = "metis module generated by nix";
                packages = with pkgs.pythonPackages; ( getPyModRec [ pkgs.pythonPackages.metis ] );
        };

        metis-py3 = pkgs.envModuleGen rec {
                name = "metis";
                moduleFilePrefix = "nix/py36";
                description = "metis module generated by nix";
                packages = with pkgs.python3Packages; ( getPyModRec [ pkgs.python3Packages.metis ] );
        };
        ...
        networkx = pkgs.envModuleGen rec {
            name = "networkx";
            moduleFilePrefix = "nix/py27";
            description = "networkx module generated by nix";
            packages = with pkgs.pythonPackages; ( getPyModRec [ pkgs.pythonPackages.networkx ] );
        };

        networkx-py3 = pkgs.envModuleGen rec {
            name = "networkx";
            moduleFilePrefix = "nix/py36";
            description = "networkx module generated by nix";
            packages = with pkgs.python3Packages; ( getPyModRec [ pkgs.pythonPackages.networkx ] );
        };
        ...
        pillow = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.pythonPackages; ( getPyModRec [ pillow ] );
        };

        pillow-py3 = pkgs.envModuleGen rec {
            name = "pillow";
            moduleFilePrefix = "nix/py36";
            description = "pillow module generated by nix";
            packages = with pkgs.python3Packages; ( getPyModRec [ pkgs.python3Packages.pillow ] );
        };
        ...
        snakemake = pkgs.envModuleGen rec {
            ...
            packages = [ pkgs.python36Packages.snakemake ];
            conflicts = conflicts-modules;
        };
       ...
       gts = pkgs.envModuleGen rec {
            name = "gts";
            version = "0.7.6";
            description = "GNU Triangulated Surface Library generated by nix";
            packages = [ pkgs.gts ];
            conflicts = [ "gts" ];
        };
		...
		scikit-learn-py3
           ...
           large_toolkit = [
            ...
            # Uncomment a plugin which you want to deploy with viz.latest jenkins plan
            # WARNING! If the plugin does not compile, no modules are deployed!
        ...
        viz_plugins = pkgs.buildEnv {
          name = "bbpviz-plugin-modules";
          paths = set.viz_plugins;
        };
