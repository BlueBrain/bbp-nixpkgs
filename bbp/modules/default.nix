...
let
    ...
    default_mpi_rdma = mvapich2-rdma;
       ...
       blender = pkgs.envModuleGen rec {
        ...
        topologyviewer = pkgs.envModuleGen rec {
            name = "topologyviewer";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "topologyviewer module generated by nix";
            packages = [
                            pkgs.topologyviewer
                       ];
            conflicts = conflicts-modules;
        ...
        membranelessorganelles = pkgs.envModuleGen rec {
            name = "membranelessorganelles";
            moduleFilePrefix = "nix/viz";

            isLibrary = true;
            description = "membranelessorganelles module generated by nix";
            packages = [
                            pkgs.membranelessorganelles
                       ];
            conflicts = conflicts-modules;
        };
