...
let
    ...
    default_mpi_rdma = if (pkgs.bbp-mpi-rdma == pkgs.mvapich2-rdma) then mvapich2-rdma
        ...
        neuron-savestate = pkgs.envModuleGen rec {
            name = "neuron-savestate";
            moduleFilePrefix = "nix/hpc";
            isLibrary = true;
            description = "neuron with save state branch module generated by nix";
            packages =
            [
                pkgs.neuron
        ...
        neuron-hippocampus = pkgs.envModuleGen rec {
            name = "neuron-hippocampus";
            moduleFilePrefix = "nix/hpc";
            isLibrary = true;
            description = "neuron with save state branch module generated by nix";
            packages =
        ...
        neuron-simplification = pkgs.envModuleGen rec {
            name = "neuron-simplification";
            moduleFilePrefix = "nix/hpc";
            isLibrary = true;
            description = "neuron with simplification branch module generated by nix";
            packages =
            [
                pkgs.neuron
        ...
        bluepy_legacy = pkgs.envModuleGen rec {
            name = "bluepy";
            moduleFilePrefix = "nix/nse";
       ...
       blender = pkgs.envModuleGen rec {
        ...
        python34-light = with pkgs; pkgs.envModuleGen rec {
            name = "python";
            version = "3.4-light";
        ...
        cmake38 = pkgs.envModuleGen rec {
            name = "cmake";
            version = "3.8";
            description = "cmake 3.8 module generated by nix";
            packages = [
                            pkgs.cmakeCurses
                       ];
            conflicts = [ "cmake" ];
        ...
        boost = pkgs.envModuleGen rec {
            ...
            description = "boost 1.58 module generated by nix";
    ...
    dev-env-python27pkgs = [
        ...
        [
            ...
            # nse team
            neurom morphsyn bluejittersdk bluerepairsdk bluepy_legacy bluepy muk morphscale
            ...
            nest mod2c coreneuron flatindexer highfive morphomesher pytouchreader 
...
with generic-modules; rec {
    ...
    phdf5 = pkgs.envModuleGen rec {
     ...
     openblas-static = pkgs.envModuleGen rec {
      ...
      bgq-neuron-savestate = neuron-savestate.override {
        # override compiler to use mpi XLC
        dependencies = [ bgq-mpi-xlc ];
        # additional override
        extraContent = ''
      ...
      bgq-neuron-hippocampus = neuron-hippocampus.override {
        # override compiler to use mpi XLC
        dependencies = [ bgq-mpi-xlc ];
        # additional override
        extraContent = ''
      ...
      all = pkgs.buildEnv {
        ...
        [
            ...
            bgq-coreneuron bgq-neuron bgq-neuron-savestate bgq-neuron-hippocampus bgq-mod2c
        ];
      };
