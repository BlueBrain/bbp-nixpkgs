    ...
    default_mpi_rdma = mvapich2-rdma;
        ...
        spykfunc = pkgs.envModuleGen rec {
            ...
            extraContent = ''
                ...
                setenv PYSPARK_PYTHON "${pkgs.pythonPackages.python}/bin/${pkgs.pythonPackages.python.executable}"
            '';
        ...
        spykfunc-py3 = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.python3Packages; [
              pkgs.spykfunc-py3
              pkgs.parquet-converters
            ] ++ ( getPyModRec [ pkgs.spykfunc-py3 ] ++ [ add-site-dir ] );
            ...
            extraContent = ''
                setenv HADOOP_HOME "${pkgs.hadoop-bbp}"
                setenv JAVA_HOME "${pkgs.jre}"
                setenv SPARK_HOME "${pkgs.spark-bbp-py3}"
        ...
        bluepy = pkgs.envModuleGen rec {
            ...
            conflicts = conflicts-modules ++ [ bluepy_0_6_1 bluepy_0_9_6 python36-full python36-light ];
        };
       ...
       blender = pkgs.envModuleGen rec {
        ...
        brayns-latest = pkgs.envModuleGen rec {
            name = "brayns";
            moduleFilePrefix = "nix/viz";
