    ...
    default_mpi_rdma = if (pkgs.bbp-mpi-rdma == pkgs.mvapich2-rdma) then mvapich2-rdma
       ...
       blender = pkgs.envModuleGen rec {
        ...
        python27-light = with pkgs; envModuleGen rec {
            ...
            conflicts = [ python35-full python35-light ] ++ conflicts-modules;
        ...
        python35-light = with pkgs; pkgs.envModuleGen rec {
            name = "python";
            version = "3.5-light";
            description = "python 3.5 module generated by nix";
            packages = let pythonPkgs = pkgs.python35Packages;
                         in
                        [
                            # basic
                            gcc
        ...
        python35-full = pkgs.envModuleGen rec {
            name = "python";
            version = "3.5-full";
            description = "python 3.5 module generated by nix";
            packages = let pythonPkgs = pkgs.python35Packages;
        ...
        boost = pkgs.envModuleGen rec {
            ...
            description = "boost 1.62 module generated by nix";
