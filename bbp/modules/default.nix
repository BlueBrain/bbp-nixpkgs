...
let 
    ...
    mpich2 = pkgs.envModuleGen rec {
        ...
        hdf5 = pkgs.envModuleGen rec {
            ...
            conflicts = conflicts-modules ++ [ "hdf5" phdf5 ];
        };
       ...
       phdf5 = pkgs.envModuleGen rec {
            ...
            conflicts = conflicts-modules ++ [ "hdf5" hdf5 ];
        };
     ...
     openblas-static = pkgs.envModuleGen rec {
      ...
      all = pkgs.buildEnv {
        ...
        [ 
            ...
            bgq-openssl  bgq-petsc bgq-scorec bgq-gsl

            bgq-cmake

            #BGQ compiler and mpi
            bgq-mpi-xlc bgq-gcc  bgq-gcc47 bgq-mpich2 bgq-ibm-mpi bgq-glibc
