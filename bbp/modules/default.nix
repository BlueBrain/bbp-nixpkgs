...
let
    ...
    dev-env-python27pkgs = [
        ...
        [
            ...
            # hpc team
            helloworld mvdtool morpho-tool hpctools functionalizer touchdetector bluebuilder neuron neuron-savestate
     ...
     openblas-static = pkgs.envModuleGen rec {
      ...
      all = pkgs.buildEnv {
        ...
        [
            ...
            # hpc team
            mvdtool hpctools functionalizer touchdetector helloworld
            bgq-coreneuron bgq-neuron bgq-neuron-savestate bgq-mod2c
        ];
      };
