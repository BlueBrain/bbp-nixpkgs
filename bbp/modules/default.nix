...
let
    ...
    default_mpi_rdma = mvapich2-rdma;
        ...
        neurodamus-syntool = pkgs.envModuleGen rec {
            name = "neurodamus-syntool";
            moduleFilePrefix = "nix/hpc";
            setRoot = "NEURODAMUS";
            isLibrary = true;
            description = "neurodamus module with SynapseReader mod to read syn2 and other formats generated by nix";
            packages =
            [
                pkgs.neurodamus
                pkgs.reportinglib
