{ config, fetchgitPrivate, pythonPackages, pynrrd, voxcell, numpy_1_13_1 }:
...
in {
  voxcell = pythonPackages.buildPythonPackage rec {
  ...
  brain-builder = pythonPackages.buildPythonPackage rec {
