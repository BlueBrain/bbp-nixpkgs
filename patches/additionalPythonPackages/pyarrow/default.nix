{ stdenv, buildPythonPackage, python, isPy3k, fetchurl, arrow, cmake, cython, futures, numpy, pandas, pytest, pytestrunner, parquet-cpp, pkgconfig, setuptools_scm, six }:

let
  _arrow = arrow.override { inherit python;};
  _parquet-cpp = parquet-cpp.override { arrow = _arrow; };
in
...
buildPythonPackage rec {
  ...
  propagatedBuildInputs = [ numpy six ] ++ stdenv.lib.optionals (!isPy3k) [ futures ];
